import cv2
""" 可以調整參數"""
cap = cv2.VideoCapture("./行人1.mp4")
car = cv2.CascadeClassifier("./models/haarcascade_fullbody.xml")    # 讀取汽車模型
...
while True:
    ...
    cars = car.detectMultiScale(gray, scaleFactor=1.1, minNeighbors=2)       # 偵測汽車
    for (x, y, w, h) in cars:
